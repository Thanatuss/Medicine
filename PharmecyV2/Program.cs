...
namespace Program
{
    public class Program
    {
        ...
        {
            services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblyContaining<CreateMedicineHandler>());
        }*/
        ...
        public static void Main(String[] args)
        {
            ...
            // ??? MediatR ???? ??????? ?? Mediator
            builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblyContaining<CreateMedicineHandler>());
